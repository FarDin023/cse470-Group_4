...
const ProfilePost = ({ details }) => {
  ...
  const shareOnTwitter = () => {
    const text = `${details.desc} | ${details.image}`; 
  ...
  return (
    <div>
      <div>
        <div className='flex flex-col card gap-3 bg-fuchsia-950 w-auto mt-7 p-5 shadow-xl'>
            ...
            <div className='flex flex-row gap-6 justify-center items-center card-actions'>
              <div>
                <span className='flex flex-row gap-3'>
                  ...
                  />
                  <p className='text-logo-text-green'>{count} Likes</p>
                </span>
              </div>
              <div>
                <span className='flex flex-row gap-3'>
